...
CV_bayes1 <- media_posterior1/sqrt(var_post1)
...
CV_boot <- media_pred_boot/sqrt(var_boot)
...
CV_MLE <- info_fisher$mle /sqrt(as.numeric(info_fisher$varcov)) # no sé si está bien xd
